...
REM -- VERIFICATION
openocd -s C:\pico\openocd\share\openocd\scripts -f interface/cmsis-dap.cfg -f target/rp2350.cfg -c "adapter speed 5000" -c "program test.bin bin 0x10080000" -c "program verify_on.bin bin 0x10088000 reset exit"